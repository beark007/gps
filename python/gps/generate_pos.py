...
def main():
    ...
    # test in a line
    # train_positions = np.array([np.array([0.00, -0.05, 0.0]),
    #                             np.array([0.30, -0.05, 0.0]),
    #                             np.array([0.00, -0.25, 0.0]),
    #                             np.array([0.30, -0.25, 0.0]),
    #                             ])

    # train_positions = np.array([np.array([0.00, -0.00, 0.0]),
    #                             np.array([0.10, -0.10, 0.0]),
    ...
    """ OLGPS paper positions"""
    # train_positions = np.array([np.array([0.00, -0.00, 0.0]),
    #                             np.array([0.00, -0.15, 0.0]),
    #                             np.array([0.15, -0.00, 0.0]),
    #                             np.array([0.15, -0.15, 0.0]),
    #                             np.array([0.30, -0.00, 0.0]),
    #                             np.array([0.30, -0.15, 0.0]),
    #                             ])

    """ OLGPS paper position the same as MDGPS"""
    train_positions = np.array([np.array([0.00, -0.20, 0.0]),
                                np.array([0.00, 0.0, 0.0]),
                                np.array([0.30, 0.0, 0.0]),
                                np.array([0.30, -0.20, 0.0]),
                                ])
    ...
    # test_position1 = generate_position(-0.25, 0.05, 0.030, 30, 0.005)
    # test_position2 = generate_position(0.00, 0.05, 0.030, 30, 0.005)
    # test_position3 = generate_position(0.25, 0.05, 0.030, 30, 0.005)
    # test_position4 = generate_position(0.25, 0.05, 0.030, 30, 0.005)

    # test_position1 = generate_position(0.00, 0.00, 0.030, 30, 0.005)
    # test_position2 = generate_position(0.10, 0.10, 0.030, 30, 0.005)
    # test_position3 = generate_position(0.20, 0.20, 0.030, 30, 0.005)
    # test_position4 = generate_position(0.25, 0.25, 0.030, 30, 0.005)

    test_position1 = generate_position(0.00, 0.20, 0.030, 5, 0.005)
    test_position2 = generate_position(0.00, -0.00, 0.030, 5, 0.005)
    test_position3 = generate_position(0.30, -0.00, 0.030, 5, 0.005)
    test_position4 = generate_position(0.30, 0.20, 0.030, 5, 0.005)
    ...
    # test_position1 = generate_position(0.00, 0.00, 0.030, 5, 0.005)
    # test_position2 = generate_position(0.00, 0.15, 0.030, 5, 0.005)
    # test_position3 = generate_position(0.15, 0.00, 0.030, 5, 0.005)
    # test_position4 = generate_position(0.15, 0.15, 0.030, 5, 0.005)
    # test_position5 = generate_position(0.30, 0.00, 0.030, 5, 0.005)
    # test_position6 = generate_position(0.30, 0.15, 0.030, 5, 0.005)
    # test_position = np.concatenate((test_position1,
    #                                 test_position2,
    #                                 test_position3,
    #                                 test_position4,
    #                                 test_position5,
    #                                 test_position6), axis=0)
    # file_pickle('./position/test_position.pkl', test_position)
    # file_pickle('./position/test_position_0.pkl', test_position1)
    # file_pickle('./position/test_position_1.pkl', test_position2)
    # file_pickle('./position/test_position_2.pkl', test_position3)
    # file_pickle('./position/test_position_3.pkl', test_position4)
    # file_pickle('./position/test_position_4.pkl', test_position5)
    # file_pickle('./position/test_position_5.pkl', test_position6)
