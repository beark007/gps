...
class GPSMain(object):
    ...
    def run(self, config, itr_load=None):
        ...
        for test_num in range(1, 6):
            ...
            test_count = 7 + test_num * 2
            for test_itr in range(6):
                itr_count += 1
                ...
                center_position = np.array([0.12, -0.12, 0])
                ...
                print('test all testing position....')
                all_test_positions = self.generate_position_radius(center_position, radius, 100, 0.01)
                cost, suc, distance = self.test_cost(all_test_positions)
